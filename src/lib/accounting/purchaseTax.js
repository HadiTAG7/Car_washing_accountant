...
//
// A twin of the server engine at functions/src/purchaseTax.js. This copy is
// what the client PREVIEW of an entry uses; that one decides what the entry
// IS. functions/test/purchaseTax.test.js drives both over one battery, so a
// preview that promises one reclaim while the ledger books another fails a
// test instead of being discovered in a filed return.
// ═══════════════════════════════════════════════════════════════════════════
